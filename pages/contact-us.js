...
<>
    ...
    >
      ...
      >
        <motion.div
          variants={title}
          className="flex flex-col w-full mb-12 text-center dark:text-white"
        >
        ...
        <motion.div variants={inputs} className="mx-auto lg:w-1/2 md:w-2/3">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="w-full p-2 pt-8 mt-8 text-center border-t border-gray-200 dark:text-white">
