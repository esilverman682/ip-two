...
//import SimpleParallax from '../components/Hero/SimpleParallax'
const content = {
  animate: {
...
const ProblemsWeSolve = () => {
  return (
    ...
    <motion.section
      exit={{ opacity: 0 }}
      className="relative text-gray-700 body-font dark:text-white "
    >
      <motion.div
        variants={content}
        animate="animate"
     ...
     <GsapHero></GsapHero>
          ...
          <h1 className="mb-4 text-2xl font-medium text-blue-900 dark:text-white sm:text-3xl title-font">
            Contact Us
          </h1>
