...
var Tweakpane = _interopDefault(require('tweakpane'));
...
function useTweaks(nameOrSchema, schemaOrSettings, settings) {
  ...
  var _settings = react.useRef(typeof nameOrSchema === 'string' ? settings : schemaOrSettings);

  var _schema = react.useRef(typeof nameOrSchema === 'string' ? schemaOrSettings : nameOrSchema);
...
exports.useTweaks = useTweaks;
//# sourceMappingURL=use-tweaks.cjs.development.js.map
